        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li class="{{ request()->is('usuarios*') ? 'active' : '' }}"><a href="{{ route('usuarios.index') }}"><i class="ti-user"></i> <span>Usuario</span></a></li>
                    <li><a href="#"><i class="ti-rol"></i> <span>Roles</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
